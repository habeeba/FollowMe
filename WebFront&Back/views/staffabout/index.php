...
This application is a web/ android app which is based on the cloud.
            ...
            <ul style="padding-left:16px;margin-top:0px;">
                <li> Make posts so students will be updated with latest changes  </li>
                <li> Creat agenda so students can book or show its contents  </li>
            </ul>
            
            <p style="margin-bottom:3px;"><strong>Instructions</strong></p>
            <ul style="padding-left:16px;margin-top:0px;">
                <li>Creat your agenda </li>
                <li>Identify maximum students in each slot </li>
                <li>Write a post if you want to inform your students with your latest updates</li>
                <li>Check who make a book with you and you can cancel it</li>
...
<br>
            <p>&copy; 2016 Faculty Of Computers and Information - Cairo University. All Rights Reserved to The project's team members.</p>

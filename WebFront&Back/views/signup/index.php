...
{
	?>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1 data-scroll-reveal="wait 0.25s, then enter top and move 40px over 1s" style="color: blue;"> Staff Sign Up</h1><br>
	<form  method="post" action="index.php?r=checksignup" onsubmit="return checkStaffForm(this);">
				<div style="color: blue;">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 250px; color: black;" type="text" name="staffName"/></div>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="mybutton1"  type="submit">Sign Up</button>
			</form>
			<br>
	<br><br><br>
...
{     
	?>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h1 data-scroll-reveal="wait 0.25s, then enter top and move 40px over 1s" style="color: blue;"> Student Sign Up</h1><br>
	<form action="index.php?r=checksignup" method="post" onsubmit="return checkStudentForm(this);">
	<div style="color: blue;">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 250px; color: black;" type="text" name="studentName"/></div>
	<div style="color: blue;">ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 250px; color: black;" type="text" name="studentID"/></div>
	<div style="color: blue;">Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 250px; color: black;" type="email" name="studentEmail"/></div>

...
else 
{
	...
	$ch = curl_init("http://localhost/basic/web/index.php?r=agenda/show-agenda");
	curl_setopt($ch, CURLOPT_POST, 1);
	curl_setopt($ch, CURLOPT_POSTFIELDS, "agendaID=".$exceptionAgendaID);
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
	$server_output = curl_exec ($ch);
	curl_close($ch);
	$output = json_decode($server_output , true) ;
...
<form action="index.php?r=updatexception" method="post">
...
<br>
<br>
<button class="mybutton2"  type="submit">Update Exception</button>
</form>
<br>
